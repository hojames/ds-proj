...
a. Digit reader - cat
b. Movie recommendations - con
c. Spam filter - cat
d. Hospitalizations - con
e. Siri - cat


2. How many features are availalbe to us for prediction in the digits dataset? 28*28 = 784
...
```{r}
heights <- heights %>% mutate(round = round(heights$height))

heights %>% filter(round == 70) %>% summarize(mean(sex =="Male"))
